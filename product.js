(function(){
  ...
  var catalog = {
    ...
    'Performance Management Strategies Explained': {
      ...
      aboutHtml:
        '<p><strong>Performance Management Strategies Explained</strong> is a comprehensive guide to designing and running an effective performance management system that unlocks the potential of your people and your organisation.</p>' +
        '<p>You will learn about the objectives and role of performance management, performance planning, corporate performance management models, appraisals, continuous feedback cycles, and performance improvement. The book also walks you through 17 proven performance management strategies to optimise organisational performance.</p>',
      toc: [
        ...
        'Defining KPIs for different businesses',
        'Calculating and measuring KPIs',
        'KPI best practices and pitfalls',
        'Corporate Performance Management (CPM) model',
        'Components of corporate performance management',
        'Implementing a CPM framework',
        'Aligning CPM with strategy',
        'Performance appraisal',
        'Importance of performance appraisal',
        'Appraisal methods and techniques',
        'Feedback and communication in appraisals',
        ...
        'Data analytics and reporting for performance',
        'Performance management in different organisational contexts',
        'Small businesses',
        'Large enterprises',
        ...
        'Minimising bias in performance appraisals',
        'Ensuring consistency and reliability in evaluations',
        'Case studies',
        'Google: OKRs and a culture of performance',
        'General Electric: from traditional to agile performance management',
        'British Civil Service: performance management in the public sector',
        'Conclusion'
      ],
    ...
    'Brand Development Explained': {
      ...
      aboutHtml:
        '<p><strong>Brand Development Explained</strong> is a comprehensive guide that demystifies the process of brand development and helps you create a powerful, unforgettable brand.</p>' +
        '<p>You will learn why brand development matters, the five elements of a strong brand (purpose, promise, identity, personality and positioning), and how to build a brand strategy that supports your business goals.</p>' +
        '<p>The book also walks you through designing your visual identity, crafting a consistent brand voice, and implementing your brand strategy across channels like your website, social media, email and content marketing.</p>',
      toc: [
        'Introduction',
        ...
        'Brand personality',
        'Brand positioning',
        'Brand strategy: creating a roadmap for success',
        'Establishing your brand vision and mission',
        'Target audience: identifying and understanding your ideal customers',
        'Competitive analysis: understanding your market landscape',
        'Brand differentiation: finding your unique selling proposition (USP)',
        ...
        'Implementing your brand strategy across channels',
        'Website',
        'Social media',
        'Email marketing',
        'Content marketing',
        ...
        'Brand monitoring: tracking your brand’s performance',
        'Adapting your brand to market changes',
        'Conclusion'
      ],
    ...
    'Ecommerce Explained': {
      ...
      aboutHtml:
        '<p><strong>Ecommerce Explained</strong> is designed to give you everything you need to know about setting up and running a successful online business.</p>' +
        '<p>You will explore different Ecommerce business models (B2B, B2C, C2C and more), understand who should be online, how to get a store live, and what it costs. You will also learn the key factors for Ecommerce success, from knowing your ideal customer and choosing the right platform to delivering a great shopping experience.</p>' +
        '<p>The book covers the importance of cross-selling and upselling, the role of abandoned carts and retargeting ads, SMART goals, automation and loyalty programs, helping you turn visitors into loyal, repeat customers.</p>',
      toc: [
        'Introduction',
        'Who should be online?',
        'How to get your store online?',
        'Cost of obtaining an e-commerce website',
        'Origin of ecommerce',
        ...
        'What is B2C? (definition and examples)',
        'Consumer to Consumer (C2C)',
        'Revenue and growth of the C2C market',
        'Examples of C2C companies',
        'How C2C differs from P2P',
        'B2B vs B2C vs C2C vs C2B',
        ...
        'Ready-to-use and editable themes',
        'App store and integrations',
        'Mobile-optimised site and functions',
        'PCI compliance',
        'Sales channel integrations',
        'Inventory management',
        'SEO tools and capabilities',
        'Customer support and scalability',
        'Checkout, payments and shipping partners',
        'Key factors for ecommerce business success',
        ...
        'Pocketing profits vs reinvesting in your ecommerce business',
        'Importance of abandoned carts',
        'Metrics and tactics related to cart abandonment',
        'Importance of retargeting ads',
        'SMART goals and how to make them happen',
        'What SMART means',
        'Outsourcing your weaknesses',
        'Business automation and what to automate',
        'Automating CRM',
        'Invoicing',
        ...
        'Office supplies (Amazon Dash & Subscribe & Save)',
        'Customer loyalty programs and automation',
      ...
      keywords: ['ecommerce','business models','upselling','smart goals','automation','loyalty','ebook']
    },
    'Financial Crisis Explained': {
      ...
      aboutHtml:
        '<p><strong>The Financial Crisis Guide</strong> brings together articles and research that explain financial crises in a clear, intuitive and accessible way. It covers everything from the causes and institutional dynamics of crises to macroeconomic developments and the behaviour of interest and inflation rates.</p>' +
        '<p>Unlike many classic books written before the last major collapse, this eBook is designed to help you understand recent crises, compare them across history, and see how recessions, inflation, stagflation and policy responses interact.</p>' +
        '<p>By the end, you will be able to make sense of economic headlines, recognise key indicators, and better prepare your personal finances and business decisions for future downturns.</p>',
      toc: [
        'Introduction',
        'What is recession?',
        ...
        'Five key recession indicators',
        'What is inflation?',
        'What drives inflation?',
        'Recession throughout history',
        'V-Day Recession (February 1945 – October 1945)',
        'Post-war brakes (Tap Recession, 1948–1949)',
        'M*A*S*H* Recession (1953–1954)',
        'Investment Bust Recession (1957–1958)',
        '“Rolling Adjustment” Recession (1960–1961)',
        'Guns and Butter Recession (1969–1970)',
        'Iran and Volcker Recession Part 1 (1980)',
        'Double-Dip Recession Part 2 (1981–1982)',
        'Gulf War Recession (1990–1991)',
        'Dot-bomb Recession (2001)',
        'The Great Recession (2007–2009)',
        'COVID-19 Recession (February 2020 – April 2020)',
        'The world’s most devastating financial crises',
        ...
        'Which is worse between stagflation and inflation?',
        'Inflation vs stagflation: how do they differ?',
        'COVID-19 recession in detail',
        ...
        'Highly leveraged households and businesses',
        'Governments with debt',
        'Owners of real estate and tangible assets',
        'CPI inflation calculator explained',
        'Different types of inflation',
        'Indicators that inflation is poised to ease',
        'Five ways to prepare your finances for a recession',
        'Six mistakes to avoid during a recession',
        'Protecting retirement accounts (e.g. 401(k)) during a recession',
        'Why unemployment rises during a recession',
        'Big risks of buying a house during a recession',
        ...
        'Difference between a savings account and a CD (certificate of deposit)',
        'Importance of credit cards',
        'Personal credit benefits',
        'Business credit benefits',
        'Effects on the economy',
        'Rewards programmes and other benefits',
        'What comes after recession?',
        'Final conclusion'
      ],
      keywords: ['financial crisis','recession','inflation','stagflation','personal finance','economics','ebook']
    },
    'Housing Crisis Explained': {
      ...
      aboutHtml:
        '<p><strong>Housing Crisis Explained</strong> gives you a deep understanding of the causes, impacts and possible solutions to the global housing crisis.</p>' +
        '<p>From historical housing bubbles to today’s complex economic, demographic and financial drivers, this eBook explains how different factors interact to create housing shortages, affordability problems and instability in markets around the world.</p>' +
        '<p>You will also learn about the roles of governments, the private sector, international organisations, NGOs, communities and individuals in tackling the crisis – and explore policy and practical solutions for the future.</p>',
      toc: [
        'Introduction',
        'Housing crisis through history',
        'Japanese housing bubble and economic crisis (1990s)',
        'US housing bubble and subprime mortgage crisis (2007)',
        'UK housing bubble and financial crisis (2008)',
        'Spanish housing bubble and financial crisis (2008)',
        'Chinese housing bubble and economic slowdown (2010s)',
        'Causes of the housing crisis',
        'Impact of the housing crisis on society',
        'Key indicators of the housing crisis',
        'Government’s role in addressing the housing crisis',
        'Private sector’s role in addressing the housing crisis',
        'International organisations’ role in solving the housing crisis',
        'Non-governmental organisations’ role in solving the housing crisis',
        'Community groups’ role in solving the housing crisis',
        'Individuals’ role in solving the housing crisis',
        'Solutions to the housing crisis: policy and practice',
        'Economic factors in the housing crisis',
        'Demographic factors in the housing crisis',
        'Lending and finance in the housing crisis',
        'Land use and development in the housing crisis',
        'Housing affordability in the housing crisis',
        'Housing discrimination in the housing crisis',
        'Homelessness in the housing crisis',
        'Suburbanisation and gentrification in the housing crisis',
        'Climate change and the natural environment in the housing crisis',
        'International trade and investment in the housing crisis',
        'Technology and innovation in the housing crisis',
        'Prefabricated homes',
        'Smart homes',
        '3D printing in housing',
        'Robots and automation in construction',
        'Virtual reality in housing design and sales',
        'Conclusion'
      ],
      keywords: ['housing','policy','real estate','affordability','urbanisation','ebook']
    },
    'Customer Relationship Explained': {
      ...
      aboutHtml:
        '<p><strong>Customer Relationship Explained</strong> shows why developing strong relationships is essential to the success of any business.</p>' +
        '<p>With 21 practical strategies, you will learn how to spot weaknesses in the customer journey, improve service at every touchpoint, and use operations and CRM techniques so that no opportunity to strengthen relationships is missed.</p>' +
        '<p>Whether you are just starting out or already established, this guide helps you create stronger bonds with customers that lead to higher satisfaction, loyalty and repeat business.</p>',
      toc: [
        'Introduction',
        'Importance of effective customer relationship',
        ...
        'Co-creation',
        'Switching costs',
        '21 strategies to build strong customer relationships',
        ...
        'Acquire customer feedback and act on it',
        'Exceed expectations',
        ...
        'Do not make customers hunt you down for answers',
        ...
        'Emotional intelligence in customer relationship',
      ...
      keywords: ['customer relationship','crm','strategy','loyalty','customer experience','ebook']
    },
    'Scrum Manual': {
      price: 19, pages: 40,
      desc: 'Master Scrum fundamentals for agile projects from sprint planning to daily scrums.',
      features: [
        'Master Scrum Fundamentals for Agile Projects',
        'Sprint Planning, Daily Scrums and more',
        'Hours of Research Simplified'
      ],
      aboutHtml:
        '<p><strong>Scrum Manual</strong> is your practical guide to bringing order to chaotic projects using the world’s most popular Agile framework.</p>' +
        '<p>You will learn the core Scrum roles, events and artefacts – from Product Backlog and Daily Scrum to Sprint Planning, Reviews and Retrospectives – and how to use them to deliver high-quality results on time, every time.</p>' +
        '<p>The manual also covers user stories, estimation, burndown charts, Scrum boards, tools, anti‑patterns to avoid and tips for running successful sprints, so you can transform the way your team plans, collaborates and ships work.</p>',
      toc: [
        'Introduction',
        ...
        'Who should run Sprint Retrospective meetings?',
        ...
        'Using Agile tools and software in Scrum',
        'Collaborating with stakeholders and external teams',
        'Managing and tracking progress with Scrum boards',
        'Closing the project: lessons learned and next steps',
        'Tips and tricks for running successful sprints',
        'Conclusion: the future of Scrum in project management'
      ],
      keywords: ['scrum','agile','sprint planning','product backlog','scrum master','ebook']
    },
    'Kanban Manual': {
      price: 19, pages: 42,
      ...
      aboutHtml:
        '<p><strong>Kanban Manual</strong> is your ultimate guide to mastering Kanban for effective project and workflow management.</p>' +
        '<p>It covers everything from the basics of Kanban boards and core principles to advanced strategies for integrating Kanban into your processes and measuring efficiency. You will learn how to visualise work, limit work in progress and maximise flow, and when Kanban is the right fit (or not) for your context.</p>' +
        '<p>Through examples and industry applications – from software development and marketing to manufacturing, services, education and the public sector – the manual shows how Kanban can transform the way teams collaborate and deliver.</p>',
      toc: [
        'Introduction',
        'What is a Kanban board and how does it work?',
        'When to use the Kanban tool and when not to use it',
        'Core principles of Kanban project management',
        'Understanding Kanban workflow',
        'Benefits of using Kanban in project management',
        'Kanban examples and case studies',
        'Integrating Kanban into your project management process',
        'Centralised communication with Kanban',
        'Kanban rules and best practices',
        'Setting up a Kanban board',
        'Creating and managing Kanban cards',
        'Managing work in progress (WIP) with Kanban',
        'Measuring and improving Kanban efficiency',
        'Kanban for Agile and Scrum teams',
        'Kanban for remote teams',
        'Kanban for software development',
        'Kanban for marketing and advertising',
        'Kanban for human resources and recruiting',
        'Kanban for manufacturing and supply chain management',
        'Kanban for service-based industries',
        'Kanban for education and training',
        'Kanban for government and public sector organisations',
        'Kanban for non-profit organisations',
        'Conclusion: the future of Kanban in project management'
      ],
      keywords: ['kanban','workflow','wip limits','agile','project management','ebook']
    },
    'Agile Manual': {
      price: 19, pages: 44,
      ...
      aboutHtml:
        '<p><strong>Agile Manual</strong> is your one-stop guide to agile methodology – from the Agile Manifesto to scaling agile across an entire organisation.</p>' +
        '<p>You will learn how to plan and run agile projects, build and manage agile teams, use advanced roadmaps, and measure the success of your agile initiatives. The manual also covers core frameworks such as Scrum, Kanban, Lean, XP, Crystal, FDD and Lean Startup.</p>' +
        '<p>You will understand the advantages of agile, how it compares to traditional project management, and how to navigate the challenges of adoption and change management.</p>',
      toc: [
        'Introduction',
        'The Agile Manifesto',
        ...
        'Scrum framework (overview in Agile context)',
        'Kanban method (overview in Agile context)',
        'Lean methodology',
        'Extreme Programming (XP)',
        'Crystal method',
        'Feature-Driven Development (FDD)',
        'Lean Startup methodology',
        'Agile vs traditional project management: comparison',
        'Challenges of implementing agile',
        'Agile metrics and measurement',
        'Agile change management',
        'Conclusion and next steps'
      ],
      keywords: ['agile','scrum','kanban','lean','xp','project management','ebook']
    },
    'Artificial Intelligence in Business Explained': {
      ...
      aboutHtml:
        '<p><strong>Artificial Intelligence in Business Explained</strong> is a comprehensive introduction to modern AI for beginners.</p>' +
        '<p>From machine learning and natural language processing to computer vision, robotics and expert systems, this guide walks you through the key concepts, algorithms and techniques that power today’s AI applications.</p>' +
        '<p>You will also learn about neural networks and deep learning, how to evaluate and improve AI models, and how AI is reshaping creativity, work, regulation and everyday life.</p>',
      toc: [
        'Introduction',
        ...
        'Power struggle in AI: who controls technology?',
        'Debate on AI creativity: can machines be creative?',
        'Overcoming the shortage of AI experts and the talent gap',
        'Tips to close the AI talent gap',
        'The paradox of AI transparency: explainable AI',
        'AI and the future of human–computer interaction',
        'Ethics of AI and robot rights',
        'AI and the philosophy of mind',
        'AI apocalypse: risks and dangers of advanced AI',
        'How AI can make everyday life easier',
        'Legal and regulatory framework for AI',
        'Enhancing human capabilities with AI',
        'Conclusion'
      ],
      keywords: ['ai','machine learning','deep learning','nlp','computer vision','robotics','ebook']
    },
    ...
    'Machine Learning Explained': {
      ...
      aboutHtml:
        '<p><strong>Machine Learning Explained</strong> is a comprehensive guide to modern ML for beginners.</p>' +
        '<p>You will learn the core concepts and techniques behind today’s machine learning systems – from supervised and unsupervised learning to neural networks and deep learning – and how they differ from other forms of AI.</p>' +
        '<p>The book also covers real-world algorithms, data preparation, model evaluation and improvement, industry use cases, and the ethical and social implications of deploying machine learning at scale.</p>',
      toc: [
        'Introduction',
        'What is machine learning and how does it differ from other forms of AI?',
        'Other forms of AI',
        'Key differences between ML and other AI approaches',
        'Common applications of machine learning',
        'Basics of machine learning algorithms',
        'Types of data in machine learning',
        'Preparing and preprocessing data for ML',
        'Supervised learning algorithms',
        'Unsupervised learning algorithms',
        'Evaluating and improving ML model performance',
        'Challenges and limitations of machine learning',
        'Data quality and quantity',
        'Overfitting and underfitting',
        'Choosing algorithms and hyperparameters',
        'Human bias and fairness',
        ...
        'What to consider when working with neural networks and deep learning',
        'AI vs machine learning vs deep learning (comparisons)',
        'Natural language processing with ML',
        'Approaches to NLP with ML',
        'Computer vision and image recognition with ML',
        'Approaches to computer vision with ML',
        'Predictive analytics with ML',
        'Approaches to predictive analytics with ML',
        ...
        'Customer service',
        'HR and talent',
        'Role of ML in transforming industries and professions',
        'Ethics and social implications of ML',
        'Bias in data',
        'Transparency and privacy',
        'Autonomy and social/economic impacts',
        'Responsibility and accountability',
        'Machine learning and big data',
        'Role of data visualisation in ML',
        'Ensemble methods in ML',
        'Transfer learning in ML',
        'Role of ML in shaping society',
        'Integration of ML with other technologies',
        'Ethical implications of advanced ML systems',
        'Bias in ML algorithms',
        'Uninterpretability and lack of transparency',
        'Privacy concerns and potential misuse',
        'Need for regulation',
        'Future of machine learning: where we are heading',
        'Conclusion'
      ],
      keywords: ['machine learning','algorithms','data processing','deep learning','ethics','ebook']
    },
    'Virtual Reality Explained': {
      ...
      aboutHtml:
        '<p><strong>Virtual Reality Explained</strong> is a comprehensive guide to VR and AR basics for beginners.</p>' +
        '<p>You will gain a clear understanding of the core concepts and technologies behind virtual and augmented reality and how these experiences are created technically and experienced by users.</p>' +
        '<p>The book also explores how VR and AR are transforming gaming, education, healthcare, architecture, entertainment and many other fields, and looks ahead to the metaverse and the future of immersive technologies.</p>',
      toc: [
        'Introduction',
        'History and evolution of VR and AR',
        'Understanding the differences between VR and AR',
        'Components of VR and AR systems',
        'Types of VR and AR applications',
        'How VR and AR work',
        'VR and AR transforming industries and professions',
        'VR and AR in gaming',
        'VR and AR in education',
        'VR and AR in healthcare',
        'VR and AR in architecture and design',
        'VR and AR in entertainment and media',
        'VR and AR in retail and e-commerce',
        'VR and AR in military and defence',
        'VR and AR in art and creativity',
        'VR and AR for social connections and communication',
        'VR and AR for travel and tourism',
        'VR and AR for sports and fitness',
        'VR and AR for product visualisation and prototyping',
        'VR and AR for training and simulation',
        'VR and AR for environmental conservation and education',
        'Impact of VR and AR on the economy and global markets',
        'Future of VR and AR: trends and predictions',
        'Introduction to the metaverse: vision and history',
        'Components of the metaverse: virtual worlds and realities',
        'Future of the metaverse: opportunities and challenges',
        'Oculus: leader in consumer VR gaming',
        'HTC Vive: pioneering room-scale VR',
        'Google Daydream and Google Glass: expanding AR boundaries',
        'Microsoft HoloLens and Windows Mixed Reality',
        'Magic Leap One: future of augmented reality',
        'Conclusion'
      ],
      keywords: ['virtual reality','augmented reality','metaverse','vr ar applications','ebook']
    }
  };
